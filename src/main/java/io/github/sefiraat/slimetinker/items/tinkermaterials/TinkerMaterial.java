    ...
    public void registerParts() {
        ...
        if (this.traitToolHead != null && traitManager.isEnabled(this.id, Ids.HEAD)) {
            new PartTemplate(
                ...
                DummySmeltery.TYPE,
                basicRecipe(Casts.CAST_SWORDBLADE.item(), getLiquidItemStack(2).item()),
                this.id
            ).register(plugin);
            ...
            new PartTemplate(
                ...
                DummySmeltery.TYPE,
                basicRecipe(Casts.CAST_HOEHEAD.item(), getLiquidItemStack(1).item()),
                this.id
            ).register(plugin);
            ...
            new PartTemplate(
                ...
                DummySmeltery.TYPE,
                basicRecipe(Casts.CAST_AXEHEAD.item(), getLiquidItemStack(1).item()),
                this.id
            ).register(plugin);
            ...
            new PartTemplate(
                ...
                DummySmeltery.TYPE,
                basicRecipe(Casts.CAST_PICKAXEHEAD.item(), getLiquidItemStack(1).item()),
                this.id
            ).register(plugin);
            ...
            new PartTemplate(
                ...
                DummySmeltery.TYPE,
                basicRecipe(Casts.CAST_SHOVELHEAD.item(), getLiquidItemStack(1).item()),
                this.id
            ).register(plugin);
        }
        ...
        if (this.traitToolRod != null && traitManager.isEnabled(this.id, Ids.ROD)) {
            new PartTemplate(
                ...
                rodStack(this.id),
                DummySmeltery.TYPE,
                basicRecipe(Casts.CAST_TOOLROD.item(), getLiquidItemStack(1).item()),
                this.id
            ).register(plugin);
        }
        ...
        if (this.traitArmorPlates != null && traitManager.isEnabled(this.id, Ids.PLATE)) {
            new PartTemplate(
                ...
                DummySmeltery.TYPE,
                basicRecipe(Casts.CAST_HELM_PLATE.item(), getLiquidItemStack(TinkerMaterialManager.AMOUNT_ARM_HELM).item()),
                this.id
            ).register(plugin);
            ...
            new PartTemplate(
                ...
                DummySmeltery.TYPE,
                basicRecipe(Casts.CAST_CHEST_PLATE.item(), getLiquidItemStack(TinkerMaterialManager.AMOUNT_ARM_CHEST).item()),
                this.id
            ).register(plugin);
            ...
            new PartTemplate(
                ...
                DummySmeltery.TYPE,
                basicRecipe(Casts.CAST_LEG_PLATE.item(), getLiquidItemStack(TinkerMaterialManager.AMOUNT_ARM_LEG).item()),
                this.id
            ).register(plugin);
            ...
            new PartTemplate(
                ...
                DummySmeltery.TYPE,
                basicRecipe(Casts.CAST_BOOT_PLATE.item(), getLiquidItemStack(TinkerMaterialManager.AMOUNT_ARM_BOOT).item()),
                this.id
            ).register(plugin);
        }
        ...
        if (this.traitArmorLinks != null && traitManager.isEnabled(this.id, Ids.LINKS)) {
            new PartTemplate(
                ...
                linksStack(this.id),
                DummySmeltery.TYPE,
                basicRecipe(Casts.CAST_MAIL_LINK.item(), getLiquidItemStack(TinkerMaterialManager.AMOUNT_ARM_LINKS).item()),
                this.id
            ).register(plugin);
        }
        ...
        if (this.traitToolHead != null || this.traitArmorPlates != null) {
            new PartTemplate(
                ...
                repairStack(this.id),
                DummySmeltery.TYPE,
                basicRecipe(Casts.CAST_REPAIRKIT.item(), getLiquidItemStack(TinkerMaterialManager.AMOUNT_KIT).item()),
                this.id
            ).register(plugin);
        }
    }
